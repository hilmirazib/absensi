...
@section('container')
    ...
    <form class="tf-form" method="POST">
        ...
        <div class="mt-2 text-right"> <a href="#">Forgot Password <i class="fa fa-key"></i></a></div>
    </form>
    <p class="mb-9 fw-3 text-center ">Don't have an Account? <a href="#" class="auth-link-rg" >Sign up</a></p>
    <div class="row">
        <div class="col">
